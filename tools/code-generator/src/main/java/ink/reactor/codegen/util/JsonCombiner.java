package ink.reactor.codegen.util;
...
public final class JsonCombiner {
    ...
    public static void main(String[] args) {
        ...
        final File input = new File("tools/code-generator/src/main/resources/combiner/input");
        final File output = new File("tools/code-generator/src/main/resources/combiner/output");
