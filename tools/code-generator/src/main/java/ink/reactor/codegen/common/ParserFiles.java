package ink.reactor.codegen.common;
...
@UtilityClass
public final class ParserFiles {

    public static final File HOME = new File("");
    public static final File OUTPUT = new File("tools/code-generator/src/main/java/ink/reactor/output");
